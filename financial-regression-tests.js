...
assertFileIncludes(appCode, '<small class="extension-client-name">Aplicacion ${index + 1}</small>', "Clientes: cada ampliacion debe mostrar Aplicacion debajo del nombre del cliente.");
